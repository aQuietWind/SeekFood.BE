...
public interface MealService {
    ...
    public List<MealDTO> merchantGetSimple(long merchantId,int start,int need);
    public List<MealDTO> merchantGetSimpleByType(long merchantId,int type,int start,int need);
    ...
    public void deleteMessage(long mealId);
}

...
public class MQNameKeyEnum {
    ...
    public static final String User_Exchange_Update_File_Queue="${mq.name.bind.user-exchange.update-file-user-queue.name}";
    public static final String User_Exchange_Delete_User_Queue="${mq.name.bind.user-exchange.delete-user-queue.name}";

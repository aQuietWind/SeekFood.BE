...
public class MerchantController {
    ...
    public Result<Void> updateMerchantMaster(String merchantMasterName, String merchantMasterCode, @RequestBody MultipartFile merchantMasterImage){
        merchantService.updateMerchantMaster(merchantMasterName, merchantMasterCode, merchantMasterImage);
        return Result.success();
    }

    //增加商家的展示图
    @PostMapping(RequestPathEnum.Merchant_Proof)
    public Result<Void> addMerchantProofImage(@RequestBody List<MultipartFile> merchantProofImages){
        merchantService
    }
    //删除商家的展示图
    @PostMapping(RequestPathEnum.Merchant_Proof)
    ...
    //修改商家的展示图
    @PostMapping(RequestPathEnum.Merchant_Proof)
    public Result<Void> updateMerchantProofImage(@RequestBody MultipartFile merchantProofImage,int index){
        merchantService
    }

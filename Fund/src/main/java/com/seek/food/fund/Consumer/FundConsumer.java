...
public class FundConsumer {
    private static final Logger log = LoggerFactory.getLogger(FundConsumer.class);
    private StringRedisTemplate stringRedisTemplate;
    private FundParamsRulesConfig fundParamsRulesConfig;
    private FundRedisKeyNameConfig fundRedisKeyNameConfig;
    private FundMapper fundMapper;
    @Autowired
    public FundConsumer(StringRedisTemplate stringRedisTemplate, FundParamsRulesConfig fundParamsRulesConfig
    ...
    @RabbitListener(queues = MQNameKeyEnum.User_Register_Exchange_Fund_Queue)
    public void fundQueue(long userId){
